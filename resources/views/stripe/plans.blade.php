                    ...
                    @foreach($plans as $key => $plan)
                        <div class="col-lg-4 mb-5 mb-lg-0">
                            <div class="bg-white p-5 rounded-lg shadow">
                                ...
                                <h2 class="h1 font-weight-bold">${{ $plan->price/100 }}<span class="text-small font-weight-normal ml-2">/ month</span></h2>
                                ...
                                <a href="{{ route('plans.checkout', $plans[$key]->plan_id) }}" class="btn btn-primary btn-block shadow rounded-pill">Choose plan</a>
                            </div>
                        </div>
                    @endforeach
                </div>
